  ...
  if (!product) {
    return (
      <div className="py-24 text-center min-h-[50vh] flex flex-col justify-center items-center">
        <h1 className="text-3xl font-albert-sans mb-4">Product Not Found</h1>
        ...
        <div className="bg-white border flex flex-col md:flex-row border-border-light rounded-sm mb-16 overflow-hidden">
          ...
          <div className="w-full md:w-1/2 p-6 md:p-12 flex flex-col">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-text-muted font-roboto text-sm">(12 customer reviews)</span>
            </div>

            <div className="flex items-baseline gap-3 mb-8">
              {product.oldPrice && (
                <span className="text-[#999999] line-through font-albert-sans text-lg">${product.oldPrice.toFixed(2)}</span>
              )}
              <span className={cn("font-albert-sans font-bold text-3xl", product.oldPrice ? "text-[#e74c3c]" : "text-foreground")}>
            ...
            <div className="flex flex-col gap-4 font-roboto text-sm border border-border-light rounded p-6 bg-white shrink-0">
              <div className="flex items-center gap-3">
                ...
                <span className="text-foreground"><strong>In Stock.</strong> Ready to ship immediately.</span>
              </div>
              <div className="flex items-center gap-3">
                <Truck className="w-5 h-5 text-text-muted" />
                <span className="text-text-muted">Free standard shipping on orders over $500.</span>
              </div>
              <div className="flex items-center gap-3">
                <ShieldCheck className="w-5 h-5 text-text-muted" />
                <span className="text-text-muted">10-year warranty on all structural elements.</span>
              </div>
            </div>

            <div className="mt-8 flex items-center gap-2 text-sm">
              <span className="font-albert-sans font-semibold">Categories:</span>
              <span className="text-text-muted">{product.category}, Furniture</span>
            </div>
            <div className="mt-2 flex items-center gap-4 text-sm">
              <span className="font-albert-sans font-semibold">Share:</span>
